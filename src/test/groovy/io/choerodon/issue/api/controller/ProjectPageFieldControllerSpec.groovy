...
class ProjectPageFieldControllerSpec extends Specification {
    ...
    def "adjustFieldOrder"() {
        ...
        def entity = restTemplate.exchange(url + "/adjust_order?pageCode=" + testPageCode + "&organizationId=" + organizationId, HttpMethod.POST, httpEntity, PageFieldVO.class, projectId)
    ...
    def "update"() {
        ...
        def entity = restTemplate.exchange(url + '/{field_id}?pageCode=' + testPageCode + "&organizationId=" + organizationId, HttpMethod.PUT, httpEntity, PageFieldVO.class, projectId, list[2].fieldId)
