...
import io.choerodon.issue.app.assembler.StateMachineAssembler;
...
public class StateMachineServiceImpl implements StateMachineService {
    ...
    @Override
    public PageInfo<StateMachineListDTO> pageQuery(Long organizationId, PageRequest pageRequest, String name, String description, String[] param) {
        ...
        List<StateMachineListDTO> stateMachineDTOS = modelMapper.map(page.getList(), new TypeToken<List<StateMachineListDTO>>() {
        }.getType());
        for (StateMachineListDTO stateMachineDTO : stateMachineDTOS) {
    ...
    public Map<String, Object> checkDelete(Long organizationId, Long stateMachineId) {
        ...
        StateMachineDTO stateMachineDTO = queryStateMachineById(organizationId, stateMachineId);
    ...
    public DeployStateMachinePayload handleStateMachineChangeStatusBySchemeIds(Long organizationId, Long ignoreStateMachineId, Long ignoreSchemeId, List<Long> schemeIds, ChangeStatus changeStatus) {
        ...
        //获取所有状态机及状态机的状态列表
        List<StateMachineWithStatusDTO> stateMachineWithStatusDTOs = queryAllWithStatus(organizationId);
