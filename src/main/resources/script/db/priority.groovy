...
databaseChangeLog(logicalFilePath: 'priority.groovy') {
    changeSet(id: '2018-08-21-create-priority', author: 'cong.cheng@hand-china.com') {
        ...
        createIndex(tableName: "priority", indexName: "priority_n1") {
            column(name: "name", type: "VARCHAR(32)")
        }
        createIndex(tableName: "priority", indexName: "priority_n2") {
            column(name: "description", type: "VARCHAR(255)")
        }

        createIndex(tableName: "priority", indexName: "priority_n3") {
