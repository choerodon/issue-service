...
databaseChangeLog(logicalFilePath: 'field_data_log.groovy') {
    changeSet(id: '2019-06-19-create-table-field-data-log', author: 'shinan.chenX@gmail.com') {
        createTable(tableName: 'field_data_log') {
        ...
        createIndex(tableName: "field_data_log", indexName: "idx_field_data_log_project_id") {
            column(name: "project_id", type: "BIGINT UNSIGNED")
        }
        createIndex(tableName: "field_data_log", indexName: "idx_field_data_log_scheme_code") {
